...
const ListingCard = (props: listingsProp) => {
  ...
  return (
    ...
    <div className="card col-sm-4  mx-auto m-2 customHover" style={style} onClick={()=>{ViewDetails(props.listing)}} >
  ...
  <div className="card-body d-flex flex-column">
    ...
    {props.listing.review_scores?.review_scores_rating?<b className="card-text text-start">Average Rating : {props.listing.review_scores.review_scores_rating}</b>:""}
